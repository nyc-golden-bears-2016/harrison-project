...
var Field = function(x_dimension, y_dimension){
...
Field.prototype.checkMoemon = function(player, cur_field){
	var moemonCode = Math.floor(Math.random() * 10);
	...
	{
		return "Homura";
	} else if ( moemonCode >= 7 && moemonCode <= 8 )
	{
		return "Nanoha";
	}
	else {
